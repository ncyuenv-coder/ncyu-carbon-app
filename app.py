...
<style>
    ...
    .batch-header-final {
        ...
        font-size: 1.15rem;
        background-color: #F4F6F6; /* 預設淡灰，會被 inline style 覆蓋 */
    }
    .batch-qty-badge {
        font-size: 0.95rem;
    ...
    .stat-title { font-size: 1.15rem; font-weight: 800; color: #2C3E50; }
    .stat-count { font-size: 1.8rem; font-weight: 900; color: var(--morandi-red); }
    .stat-body {
        padding: 15px 20px;
        font-size: 0.95rem;
        color: #566573;
    ...
    .stat-row:last-child {
        border-bottom: none; padding-top: 5px; font-weight: bold; color: #2C3E50;
    }

    /* --- V108: 後台 - 重點資訊卡 (Top KPI) --- */
    .top-kpi-card {
        background-color: #FFFFFF;
        border-radius: 12px;
        padding: 20px;
    ...
    .top-kpi-title { font-size: 1.1rem; color: #7F8C8D; font-weight: bold; margin-bottom: 5px; }
    .top-kpi-value { font-size: 2.5rem; color: #2C3E50; font-weight: 900; }
    .top-kpi-icon { font-size: 2rem; margin-bottom: 5px; display: block; }
...
# ------------------------------------------
    ...
    st.markdown('<div class="contact-footer">管理員系統版本 V108.0 (Visual Refined)</div>', unsafe_allow_html=True)