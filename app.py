...
<style>
    /* =========================================
       🎨 V97.0 經典完整＋穩定修復版 (Base: V95 + Fixes)
       ========================================= */
...
# ------------------------------------------
    ...
    st.markdown('<div class="contact-footer">管理員系統版本 V97.0 (Ultimate Full Stable)</div>', unsafe_allow_html=True)