...
if "token" in query_params:
    ...
    # 🟢 精準修正：加入 url_path 對齊網址，並設為 default=True 解決 Page not found
    gas_report = st.Page("pages/9_💨_實驗室氣體鋼瓶資料回報.py", title="實驗室氣體鋼瓶資料回報", icon="📃", url_path="實驗室氣體鋼瓶資料回報", default=True)
...
if st.session_state.get("authentication_status"):
    ...
    gas_report = st.Page("pages/9_💨_實驗室氣體鋼瓶資料回報.py", title="實驗室氣體鋼瓶資料回報", icon="📃", url_path="實驗室氣體鋼瓶資料回報")
