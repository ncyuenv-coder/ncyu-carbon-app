...
# ------------------------------------------
    ...
    st.markdown('<div class="contact-footer">管理員系統版本 V107.0 (Full Verified)</div>', unsafe_allow_html=True)