...
# ------------------------------------------
    ...
    st.markdown('<div class="contact-footer">管理員系統版本 V117.0 (Final Checked)</div>', unsafe_allow_html=True)