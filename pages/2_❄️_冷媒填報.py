...
# ==========================================
# 1. 內建備援資料 (Fallback Data - 完整展開)
# 當 Google Sheet 連線失敗時，系統會自動切換使用此處資料
# ==========================================

FALLBACK_UNIT_DATA = {
    '教務處': [
        '教務長室/副教務長室/專門委員室', '註冊與課務組', '教學發展組', 
        '招生與出版組', '綜合行政組', '通識教育中心', '民雄教務'
    ],
    '學生事務處': [
        '學務長室/副學務長室', '住宿服務組', '生活輔導組', '課外活動組', 
        '學生輔導中心', '學生職涯發展中心', '衛生保健組', 
        '原住民族學生資源中心', '特殊教育學生資源中心', '民雄學務'
    ],
    '總務處': [
        '總務長室/副總務長室/簡任秘書室', '事務組', '出納組', 
        '文書組', '資產經營管理組', '營繕組', '民雄總務', '新民聯辦', '駐衛警察隊'
    ],
    '研究發展處': [
        '研發長室/副研發長室', '綜合企劃組', '學術發展組', '校務研究組'
    ],
    '產學營運及推廣處': [
        '產學營運及推廣處長室', '行政管理組', '產學創育推廣中心'
    ],
    '國際事務處': [
        '國際事務長室', '境外生事務組', '國際合作組'
    ],
    '圖書資訊處': [
        '圖資長室', '圖資管理組', '資訊網路組', '諮詢服務組', 
        '系統資訊組', '民雄圖書資訊', '新民分館', '民雄分館'
    ],
    '校長室': ['校長室'],
    '行政副校長室': ['行政副校長室'],
    '學術副校長室': ['學術副校長室'],
    ...
    '理工學院': [
        '理工學院辦公室', '應用數學系', '電子物理學系', '應用化學系', 
        '資訊工程學系', '生物機電工程學系', '土木與水資源工程學系', 
        '水工與材料試驗場', '電機工程學系', '機械與能源工程學系'
    ],
    '農學院': [
        '農學院辦公室', '農藝學系', '園藝學系', '森林暨自然資源學系', 
        '木質材料與設計學系', '動物科學系', '農業經濟學系', 
        '生物農業科技學系', '景觀學系', '植物醫學系', '農場管理進修學士學位學程'
    ],
    '生命科學院': [
        '生命科學院辦公室', '食品科學系', '水生生物科學系', 
        '生物資源學系', '生化科技學系', '微生物免疫與生物藥學系'
    ],
    '管理學院': [
        '管理學院辦公室', '企業管理學系', '應用經濟學系', 
        '生物事業管理學系', '資訊管理學系', '財務金融學系', 
        '行銷與觀光管理學系', '全英文授課觀光暨管理學士學位學程'
    ],
    '獸醫學院': [
        '獸醫學院辦公室', '獸醫學系', '雲嘉南動物疾病診斷中心', '動物醫院'
    ],
    '師範學院': [
        '師範學院辦公室', '教育學系', '輔導與諮商學系', '體育與健康休閒學系', 
        '特殊教育學系', '幼兒教育學系', '教育行政與政策發展研究所', '數理教育研究所'
    ],
    '人文藝術學院': [
        '人文藝術學院辦公室', '中國文學系', '外國語言學系', 
        '應用歷史學系', '視覺藝術學系', '音樂學系'
    ]
}
...
FALLBACK_BUILDING_DATA = {
    '蘭潭校區': [
        'A01行政中心', 'A02森林館', 'A03動物科學館', 'A04農園館', 'A05工程館', 
        'A06食品科學館', 'A07嘉禾館', 'A08瑞穗館', 'A09游泳池', 
        'A10機械與能源工程學系創新育成大樓', 'A11木材利用工廠', 'A12動物試驗場', 
        'A13司令台', 'A14學生活動中心', 'A15電物一館', 'A16理工大樓', 
        'A17應化一館', 'A18A應化二館', 'A18B電物二館', 'A19農藝場管理室', 
        'A20國際交流學園', 'A21水工與材料試驗場', 'A22食品加工廠', 'A23機電館', 
        'A24生物資源館', 'A25生命科學館', 'A26農業科學館', 'A27植物醫學系館', 
        'A28水生生物科學館', 'A29園藝場管理室', 'A30園藝技藝中心', 'A31圖書資訊館', 
        'A32綜合教學大樓', 'A33生物農業科技二館', 'A34嘉大植物園', 'A35生技健康館', 
        'A36景觀學系大樓', 'A37森林生物多樣性館', 'A38動物產品研發推廣中心', 
        'A39學生活動廣場', 'A40焚化爐設備車倉庫', 'A41生物機械產業實驗室', 
        'A44有機蔬菜溫室', 'A45蝴蝶蘭溫室', 'A46魚類保育研究中心', 
        'A71員工單身宿舍', 'A72學苑餐廳', 'A73學一舍', 'A74學二舍', 
        'A75學三舍', 'A76學五舍', 'A77學六舍', 'A78農產品展售中心', 
        'A79綠建築', 'A80嘉大昆蟲館', 'A81蘭潭招待所', 'A82警衛室'
    ],
    '民雄校區': [
        'B01創意樓', 'B02大學館', 'B03教育館', 'B04新藝樓', 'B06警衛室', 
        'B07鍋爐間', 'B08司令台', 'B09加氯室', 'B10游泳池', 'B12工友室', 
        'BA行政大樓', 'BB初等教育館', 'BC圖書館', 'BD樂育堂', 'BE學人單身宿舍', 
        'BF綠園二舍', 'BG餐廳', 'BH綠園一舍', 'BI科學館', 'BJ人文館', 
        'BK音樂館', 'BL藝術館', 'BM文薈廳', 'BN社團教室'
    ],
    '林森校區': [
        'C01警衛室', 'C02司令台', 'CA第一棟大樓', 'CB進修部大樓', 
        'CD國民輔導大樓', 'CE第二棟大樓', 'CF實輔室', 'CG圖書館', 
        'CH視聽教室', 'CI明德齋', 'CK餐廳', 'CL青雲齋', 'CN樂育堂', 
        'CP空大學習指導中心'
    ],
    '新民校區': [
        'D01管理學院大樓A棟', 'D02管理學院大樓B棟', 'D03明德樓', 
        'D04獸醫館(獸醫學系、動物醫院、雲嘉南動物疾病診斷中心)', 
        'D05游泳池', 'D06溫室', 'D07司令台', 'D08警衛室'
    ],
    '社口林場': ['E01林場實習館'],
    '林森校區-民國路': ['F01民國路進德樓']
}
...
FALLBACK_REF_TYPES = [
    'HFC-1234yf 或 R-1234yf (2,3,3,3-四氟1-丙烯)，CF3CF=CH2', 
    'HFC-125 或 R-125 (1,1,1,2,2-五氟乙烷)，CHF2CF3', 
    'HFC-134a 或 R-134a (1,1,1,2-四氟乙烷)，CH2FCF3', 
    'HFC-143a 或 R-143a (1,1,1-三氟乙烷)，CH3CF3', 
    'HFC-23 或 R-23 (三氟甲烷)，CHF3', 
    'HFC-245fa 或 R-245fa (1,1,1,3,3-五氟丙烷)，CHF2CH2CF3', 
    'HFC-32 或 R-32 (二氟甲烷)，CH2F2', 
    ...
    'R404a，HFC-125/HFC-143a/HFC-134a(44.0/52.0/4.0)', 
    'R407c，HFC-32/HFC-125/HFC-134a(23.0/25.0/52.0)', 
    'R408a，HFC-125/HFC-143a/HCFC-22(7.0/46.0/47.0)', 
    'R410a，HFC-32/HFC-125(50.0/50.0)'
]

FALLBACK_GWP_MAP = {
    'HFC-1234yf 或 R-1234yf (2,3,3,3-四氟1-丙烯)，CF3CF=CH2': 0.0, 
    'HFC-125 或 R-125 (1,1,1,2,2-五氟乙烷)，CHF2CF3': 3170.0, 
    'HFC-134a 或 R-134a (1,1,1,2-四氟乙烷)，CH2FCF3': 1300.0, 
    'HFC-143a 或 R-143a (1,1,1-三氟乙烷)，CH3CF3': 4800.0, 
    'HFC-245fa 或 R-245fa (1,1,1,3,3-五氟丙烷)，CHF2CH2CF3': 858.0, 
    'R404a，HFC-125/HFC-143a/HFC-134a(44.0/52.0/4.0)': 3942.8, 
    'R407c，HFC-32/HFC-125/HFC-134a(23.0/25.0/52.0)': 1624.21, 
    'R-407D，HFC-32/HFC-125/HFC-134a(15.0/15.0/70.0)': 1487.05, 
    'R408a，HFC-125/HFC-143a/HCFC-22(7.0/46.0/47.0)': 2429.9, 
    'R410a，HFC-32/HFC-125(50.0/50.0)': 1923.5, 
    'R-507A，HFC-125/HFC-143a(50.0/50.0)': 3985.0, 
    'R-508A，HFC-23/PFC-116(39.0/61.0)': 11607.0, 
    'R-508B，HFC-23/PFC-116(46.0/54.0)': 11698.0, 
    'HFC-23 或 R-23 (三氟甲烷)，CHF3': 12400.0, 
    'HFC-32 或 R-32 (二氟甲烷)，CH2F2': 677.0, 
    'R-411A，HC-1270/HCFC-22/HFC-152a(1.5/87.5/11.0)': 0.0, 
...
if is_admin:
    with st.sidebar:
        st.markdown("### 👁️ 檢視模式")
        mode = st.radio("請選擇功能區", ["📝 一般填報/查詢", "⚙️ 管理員後台"], index=0)
...
# ==========================================
    ...
    csv = df_yr.to_csv(index=False).encode('utf-8-sig')
    c_top2.download_button("📥 下載原始填報資料明細 (CSV)", data=csv, file_name=f"冷媒填報明細_{sel_year}.csv", mime="text/csv", type="primary")
