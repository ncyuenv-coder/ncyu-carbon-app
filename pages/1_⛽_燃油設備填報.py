                ...
                if selected_dept in VIP_UNITS:
                    ...
                    if selected_device:
                        ...
                        info_html = (
                            ...
                            f'<div style="display: flex; justify-content: space-around; padding: 20px 10px; background-color: #FFFFFF; font-size: 1.1rem;">'
                            f'<div style="text-align: center; border-right: 1px solid #EAEDED; flex: 1;"><strong>🏢 部門</strong><br><span style="color:#2C3E50; font-weight:800; font-size:1.2rem;">{row.get("設備所屬單位/部門", "-")}</span></div>'
                            f'<div style="text-align: center; border-right: 1px solid #EAEDED; flex: 1;"><strong>👤 保管人</strong><br><span style="color:#2C3E50; font-weight:800; font-size:1.2rem;">{row.get("保管人", "-")}</span></div>'
                            f'<div style="text-align: center; border-right: 1px solid #EAEDED; flex: 1;"><strong>📍 位置</strong><br><span style="color:#2C3E50; font-weight:800; font-size:1.2rem;">{row.get("設備詳細位置/樓層", "-")}</span></div>'
                            f'<div style="text-align: center; border-right: 1px solid #EAEDED; flex: 1;"><strong>⛽ 燃料</strong><br><span style="color:#2C3E50; font-weight:800; font-size:1.2rem;">{row.get("原燃物料名稱", "-")}</span></div>'
                            f'<div style="text-align: center; flex: 1;"><strong>📊 數量</strong><br><span style="color:#C0392B; font-weight:900; font-size:1.3rem;">{row.get("設備數量", "-")}</span></div>'
                            f'</div></div>'
                        )
                        st.markdown(info_html, unsafe_allow_html=True)
