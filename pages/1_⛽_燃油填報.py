        ...
        if not df_records.empty:
            ...
            if query_dept and query_year:
                ...
                if not df_final.empty:
                    ...
                    # V164.1 Modification: Added thousands separators {:,.2f}
                    ...
                    for dev in unique_devices:
                        ...
                        # V164.1 Modification: No inner text, only hover with comma
                    ...
                    # V164.1 Modification: Added thousands separator to total label
                        ...
                        for k in range(0, len(device_list), 2):
                            ...
                            for m in range(2):
                                if k + m < len(device_list):
                                    ...
                                    with d_cols[m]:
                                        # V164.1 Modification: Added comma to d_vol
                                        st.markdown(f"""
                    ...
                    st.markdown("---")
                    # V164.1 Modification: Changed Pie to Horizontal Bar Chart & Added commas
