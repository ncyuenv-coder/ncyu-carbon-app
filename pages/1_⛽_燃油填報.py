...
<style>
    ...
    /* V141: 移除 pie-chart-box 樣式，改用原生容器避免空白框 */
...
def render_user_interface():
    ...
    st.markdown('<div class="contact-footer">管理員系統版本 V141.0 (Fuel Final Perfect)</div>', unsafe_allow_html=True)
