...
def load_fuel_data():
    ...
    df_e = pd.DataFrame(); df_r = pd.DataFrame()
...
if username == 'admin':
    ...
    st.markdown('<div class="contact-footer">管理員系統版本 V134.0 (Fuel Fixed)</div>', unsafe_allow_html=True)
